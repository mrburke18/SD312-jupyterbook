...
Make a new notebook called `05MatrixComp.ipynb`, and copy over all your functions. Build the best model you can, where "best" is defined in terms of test error and qualitative performance.  To do this well, you should demonstrate appropriate and well-explained searches for optimizing the following:
