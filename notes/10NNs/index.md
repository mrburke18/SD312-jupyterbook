...
- Neurons are arguably badly named. A *neuron* takes in a number of features, performs a linear combination of them, then applies a nonlinear "activation function" to the result. The weights of the linear combination are learnable to make the final output of the neuron more accurate.
